PROGRAM COSS
! Configuration Optimization with ML assisted Monte Carlo (Basin hopping)
...
!------------------------------------------------------------------
! Swap happen between atoms labeled as  the same type of site, e.g.
...
! Swap only happen between diff. species at the same site_i.
!-----------------------------------------------------------------
...
call random_seed()
open(1,file='COSS.out',status='replace')
